    ...
    <table class="items-table">
        ...
        <tfoot>
            ...
            <tr style="font-size: 12px; color: #4b5563;">
                <td style="padding: 6px 12px; border-top: 1px solid #e5e7eb;">Total Brut</td>
                <td colspan="3" style="padding: 6px 12px; border-top: 1px solid #e5e7eb;"></td>
            ...
            <tr style="font-size: 12px; color: #dc2626;">
                <td style="padding: 6px 12px;">Remise</td>
            ...
            @endif
            <tr class="total-row">
                <td class="total-label" style="border-top: 2px solid #111827; padding-top: 12px; font-weight: bold; font-size: 16px;">Total TTC</td>
                <td class="text-center" style="font-size: 13px; color: #4b5563; font-weight: bold; border-top: 2px solid #111827; padding-top: 12px;">{{ $invoice->items->count() }} article(s)</td>
                <td colspan="2" style="border-top: 2px solid #111827; padding-top: 12px;"></td>
                <td class="total-amount" style="border-top: 2px solid #111827; padding-top: 12px; font-weight: bold; font-size: 16px;">{{ number_format($invoice->total, 2) }} DH</td>
            </tr>
        </tfoot>
    </table>
