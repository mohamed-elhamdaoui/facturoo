...
<div class="max-w-xl mx-auto bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
    <div class="px-6 py-5 border-b border-slate-200 bg-slate-50">
        <h3 class="text-lg font-semibold text-slate-900">Ajouter un client</h3>
        <p class="mt-1 text-sm text-slate-500">Enregistrez les informations de votre nouveau client.</p>
    </div>
