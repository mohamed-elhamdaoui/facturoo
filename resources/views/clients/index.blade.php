                            ...
                            <tr class="client-row hover:bg-slate-50/80 transition-colors" data-name="{{ strtolower($client->name) }}">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <a href="{{ route('clients.show', $client) }}" class="text-sm font-semibold text-slate-900 hover:text-indigo-600 transition-colors">{{ $client->name }}</a>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end gap-2">
                                        <a href="{{ route('clients.show', $client) }}" class="text-slate-600 hover:text-slate-900 bg-slate-50 hover:bg-slate-100 p-2.5 rounded-lg transition-colors border border-slate-200" title="Voir les factures">
